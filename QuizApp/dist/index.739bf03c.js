...
document.querySelector("#homepage-startGame button").addEventListener("click", ()=>{
    (0, _scriptJs.openModal)("enterNameModal");
});
document.querySelector("#enterNameModal button[type=submit]").addEventListener("click", ()=>{
    let name = document.querySelector("#enterNameModal input").value;
    if (!name || name.length > 8) alert("Wrong");
    else {
        (0, _scriptJs.closeModal)("enterNameModal");
        (0, _scriptJs.saveInitialUsername)(name);
        (0, _scriptJs.openModal)("startGameModal");
    }
});
document.querySelector("#startGameModal .close-button").addEventListener("click", ()=>{
    (0, _scriptJs.closeModal)("startGameModal");
    (0, _scriptJs.clearUsername)();
});
document.querySelector("#enterNameModal .close-button").addEventListener("click", ()=>{
    (0, _scriptJs.closeModal)("enterNameModal");
    fetchAllQuestions();
});
document.querySelectorAll(".startGameModal-buttons button")[0].addEventListener("click", ()=>{
    window.location.href = "./questions.html";
});
document.querySelectorAll(".startGameModal-buttons button")[1].addEventListener("click", ()=>{
    (0, _scriptJs.closeModal)("startGameModal");
    (0, _scriptJs.clearUsername)();
});
...
},{}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequire3324")
